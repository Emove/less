...
func TestNewBufferWriter(t *testing.T) {
	t.Logf("%#v", NewBufferWriterWithBuf(&testWriter{}).(*writer))
}
...
func Test_writer_Write(t *testing.T) {
	...
	d := &testWriter{}
	writer := NewBufferWriterWithBuf(d).(*writer)
...
func Test_writer_Flush(t *testing.T) {
	...
	bufferWriter := NewBufferWriterWithBuf(decorator)
...
func Test_writer_Malloc(t *testing.T) {
	...
	decorator := &testWriter{}
	bufferWriter := NewBufferWriterWithBuf(decorator).(*writer)
	doMalloc := func() {
